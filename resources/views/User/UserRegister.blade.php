        ...
        <div class="col-sm-12 d-flex flex-column justify-content-center" >
            <form action="{{ route('user.register') }}" method="POST">
                ...
                <div class="form-group">
                        <input type="text" id="input" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" name="name" id="name" placeholder="Usuario">
                        @if($errors->has('name'))
                ...
                <button type="submit" class="btn btn-success col-sm-12" id="btn-rosa"><h5 id="texto-preto">Registrar</h2></button>
            </form>
        </div>
    </div>
</div>
